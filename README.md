About human_readable-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/human_readable-feedstock/blob/main/LICENSE.txt)

Home: https://github.com/staticdev/human-readable
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=27261&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/human_readable-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `human_readable` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating human_readable-feedstock
=================================

If you would like to improve the human_readable recipe or build a new
...
Note that all branches in the conda-forge/human_readable-feedstock are
